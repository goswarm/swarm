#!/usr/bin/env python
# $Id: daemonize.py 1824 2008-09-27 05:24:40Z saunders $
# $URL: svn+ssh://akrill@dev.foodista.com/usr/local/repos/projects/common/src/daemonize.py $
import sys, os
...
def daemonize (stdin='/dev/null', stdout='/dev/null', stderr='/dev/null', pidfile='/dev/null'):
...
if __name__ == "__main__":
    daemonize('/dev/null','/tmp/daemon.log','/tmp/daemon.log', '/tmp/daemon.pid')
    main()
