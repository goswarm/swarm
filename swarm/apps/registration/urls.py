...
from swarm.apps.registration.views import activate, register, registration_complete
...
urlpatterns = patterns('',
   ...
   url(r'^login/$', 'swarm.apps.registration.views.login', {'template_name': 'registration/login.html'}, name='auth_login'),
   url(r'^logout/$', 'swarm.apps.registration.views.logout', {'template_name': 'registration/logout.html'}, name='auth_logout'),
